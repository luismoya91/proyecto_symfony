...
use luis_symfonyBundle\Form\EmpleadorType;
...
class EmpleadorController extends Controller
{
	...
	public function crearempleadorAction()
	{
		$empleador = new Empleador();
		$form = $this->createCreateForm($empleador);
		
		return $this->render('empleador/crearempleador.html.twig', array('form'=>$form->createView()));
	}
	
	private function createCreateForm(Empleador $entity)
	{
		$form = $this->createForm(EmpleadorType::class,$entity,array(
			'action' => $this->generateUrl('luis.symfony_cempleadorn'),
			'method' => 'POST'
		));
		return $form;
	}
	...
	public function createAction(Request $request)
	{
		...
		if($form->isValid())
		{
			...
			return $this->redirectToRoute('luis.symfony_inicio');	
		}
		return $this->render('empleador/crearempleador.html.twig', array('form'=>$form->createView()));
	}
