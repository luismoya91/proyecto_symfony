...
use luis_symfonyBundle\Form\EmpleadoType;
...
class EmpleadoController extends Controller
{
	...
	public function crearempleadoAction()
	{
		...
		return $this->render('empleado/crearempleado.html.twig', array('form'=>$form->createView()));
	}
	
	private function createCreateForm(Empleado $entity)
	{
		$form = $this->createForm(EmpleadoType::class,$entity,array(
			'action' => $this->generateUrl('luis.symfony_cempleadon'),
			'method' => 'POST'
		));
		return $form;
	}
